...
urlpatterns = [
    ...
    path('favourite-product-create/', views.FavouriteProductCreateView.as_view(), name='favourite-product-create'),
    path('favourite-product/<int:pk>/delete/', views.FavouriteProductDeleteView.as_view(), name='favourite-product-delete'),
    path('my-favourite-product/', views.FavouriteProductListView.as_view(), name='my-favourite-products'),
]